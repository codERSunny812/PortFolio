...
import astronaut from "../assets/bot.json";
  ...
  return (
    <>
      <div className='relative overflow-hidden lg:overflow-visible'>
        ...
        <a href="/cv.pdf" download="Sushil_CV.pdf">
          <button type="button" className="mt-4 z-10 bg-indigo-sunny text-white py-2 px-4 rounded-lg hover:bg-indigo-btn">
            Download CV
          </button>
        </a>
