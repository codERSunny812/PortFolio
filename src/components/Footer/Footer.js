...
const Footer = () => {
  ...
  return (
    <footer
      className="w-full relative select-none bg-cover bg-gradient-to-r from-indigo-light to-indigo-dark" // Use Tailwind utility classes
    >
      <FooterBg />
        ...
        <div className="w-full h-full pt-32">
          <div className="section-container flex flex-col h-full justify-end z-10 items-center py-12">
            ...
            <p className="text-center text-white text-sm sm:text-base font-medium tracking-wide mt-8">
              ...
              by <span className="text-white">Sushil Pandey</span>
            </p>
          </div>
        </div>
      {/* </Fade> */}
